...
public class MainActivity extends AppCompatActivity {
    ...
    public void getData(){
        ...
        persons.add(new Person(R.drawable.p2,"Lim Malsook","010-9098-2983"));
        persons.add(new Person(R.drawable.p3,"Kim Malsook","010-9098-2983"));
        ...
        persons.add(new Person(R.drawable.p6,"Moon Malsook","010-9098-2983"));
        persons.add(new Person(R.drawable.p7,"Ko Malsook","010-9098-2983"));
        persons.add(new Person(R.drawable.p8,"Jung Malsook","010-9098-2983"));
        persons.add(new Person(R.drawable.p9,"Jang Malsook","010-9098-2983"));
        setList(persons);
    }
